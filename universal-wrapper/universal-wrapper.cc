...
extern "C" float Posit8es0ToFloat(uint8_t in) {
  return Uint8ToPosit8es0(in).operator float();
}

extern "C" uint8_t FloatToPosit8es0(float in) {
  auto posit = sw::unum::posit<8, 0>(in);
  return Posit8es0toUint8(posit);
}

// TODO(gus) how wide should the input be?
extern "C" uint8_t IntToPosit8es0(int in) {
  return Posit8es0toUint8(sw::unum::posit<8, 0>(in));
}

extern "C" uint8_t Posit8es0Add(uint8_t a, uint8_t b) {
  return Posit8es0toUint8(Uint8ToPosit8es0(a) + Uint8ToPosit8es0(b));
}

extern "C" uint8_t Posit8es0Sub(uint8_t a, uint8_t b) {
  return Posit8es0toUint8(Uint8ToPosit8es0(a) - Uint8ToPosit8es0(b));
}

extern "C" uint8_t Posit8es0Mul(uint8_t a, uint8_t b) {
  return Posit8es0toUint8(Uint8ToPosit8es0(a) * Uint8ToPosit8es0(b));
}

extern "C" uint8_t Posit8es0Div(uint8_t a, uint8_t b) {
  return Posit8es0toUint8(Uint8ToPosit8es0(a) / Uint8ToPosit8es0(b));
}

extern "C" uint8_t Posit8es0Max(uint8_t a, uint8_t b) {
  auto a_p = Uint8ToPosit8es0(a);
  auto b_p = Uint8ToPosit8es0(b);
  return Posit8es0toUint8(a_p > b_p ? a_p : b_p);
}

extern "C" uint8_t Posit8es0Sqrt(uint8_t a) {
  return Posit8es0toUint8(sw::unum::sqrt(Uint8ToPosit8es0(a)));
}

extern "C" uint8_t Posit8es0Exp(uint8_t a) {
