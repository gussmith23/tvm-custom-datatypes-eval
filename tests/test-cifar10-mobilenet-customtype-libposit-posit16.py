...
from util.load_datatypes import load_libposit_posit16
...
load_libposit_posit16()

# Change the datatype
conversion_executor = relay.create_executor()
expr, params = change_dtype('float32', 'custom[libposit-posit16]16', module['main'],
                            params, conversion_executor)
module = relay.module.Module.from_expr(expr)

run_pretrained_model_test(module, params, dataset, 'custom[libposit-posit16]16')
